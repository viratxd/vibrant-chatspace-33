              ...
              <div className="space-y-2">
                ...
                <Select value={grade} onValueChange={setGrade} required>
                  ...
                  <SelectContent className="bg-secondary">
                    <SelectItem value="10" className="text-sm text-white sm:text-base">Class 10</SelectItem>
                    <SelectItem value="11" className="text-sm text-white sm:text-base">Class 11</SelectItem>
